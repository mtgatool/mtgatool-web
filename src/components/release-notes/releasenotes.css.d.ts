declare namespace ReleasenotesCssModule {
...
declare const ReleasenotesCssModule: ReleasenotesCssModule.IReleasenotesCss & {
  /** WARNING: Only available when `css-loader` is used without `style-loader` or `mini-css-extract-plugin` */
  locals: ReleasenotesCssModule.IReleasenotesCss;
};
